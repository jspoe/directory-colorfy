...
(function(){
	...
	var Colorfy = function( filepath, extraColors, opts ){
		opts = opts || {};
		this.noColorFiles = opts.noColorFiles;
	...
	Colorfy.prototype._getColorConfig = function( str, extraColors ){
		...
		if( colors ){
			...
			if (this.noColorFiles) {
				Object.values(extraColors).forEach( function( color, i) {
					var colorKey = Object.keys(extraColors)[i]
					colorObj[ colorKey ] =
						extraColors[ colorKey ];
				});
			}
			return colorObj;
		}
